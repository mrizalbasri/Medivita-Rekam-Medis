          ...
          return (
            <div
              ...
              className={`rounded-2xl border transition-all duration-300 ${
                isOpen
                  ? "border-[#2AACAB]/30 bg-white shadow-[0_12px_30px_rgba(42,172,171,0.04)]"
            ...
            >
              ...
              >
                ...
                <span
                  className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-ink-soft/5 transition-transform duration-300 ${
                    isOpen ? "rotate-45 bg-[#2AACAB]/10 text-[#2AACAB]" : "text-ink-soft/70"
                  }`}
                >
                  <svg
                    width="14"
